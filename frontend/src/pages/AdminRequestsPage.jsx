...
export function AdminRequestsPage() {
  ...
  useEffect(() => {
    setHeader('Service Requests Management', 'Monitor and manage all service requests across the platform.');
    loadRequests();
  }, [setHeader]);
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="rounded-[28px] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">Pending</p>
                <p className="text-2xl font-bold text-slate-900 dark:text-slate-100">
          ...
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            ...
            <div className="flex gap-3">
              <select
                ...
                className="rounded-[18px] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 px-4 py-2.5 text-sm focus:border-blue-500 dark:focus:border-blue-400 focus:outline-none"
              >
              ...
              <div className="relative">
                ...
                <input
                  ...
                  className="rounded-[18px] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 pl-10 pr-4 py-2.5 text-sm placeholder-slate-400 dark:placeholder-slate-500 focus:border-blue-500 dark:focus:border-blue-400 focus:outline-none"
                />
              </div>
            </div>
          </div>
          ...
          <div className="mt-6 space-y-3">
            {loading ? (
              <div className="py-8 text-center">
                <div className="mx-auto h-8 w-8 animate-spin rounded-full border-4 border-slate-200 dark:border-slate-800 border-t-blue-600" />
                    ...
                    {request.status === 'pending' && (
                      <>
                        ...
                        <button
                          ...
                          className="rounded-[18px] border border-slate-200 dark:border-slate-800 bg-slate-50 dark:bg-slate-900 px-4 py-2.5 text-sm font-semibold text-slate-700 dark:text-slate-300 transition hover:bg-slate-100 dark:hover:bg-slate-800 dark:bg-slate-800"
                        >
                          Cancel
                        </button>
                      </>
