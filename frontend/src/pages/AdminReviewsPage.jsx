...
export function AdminReviewsPage() {
  ...
  useEffect(() => {
    setHeader('Review Moderation', 'Monitor and moderate all reviews across the platform.');
    loadReviews();
  }, [setHeader]);
      ...
      {feedback && (
        ...
        <div className="rounded-[28px] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6 shadow-sm">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">All Reviews</h3>
          ...
          <div className="mt-6 space-y-3">
            {loading ? (
              ...
              filteredReviews.map((review) => (
                <div
                  key={review.id}
                  className="flex flex-col gap-3 rounded-[24px] border border-slate-100 bg-slate-50 dark:bg-slate-900/80 p-4"
                >
