...
export function AdminOrdersPage() {
  ...
  useEffect(() => {
    setHeader('Order Management', 'Monitor and manage all orders across the platform.');
    loadOrders();
  }, [setHeader]);
      ...
      {feedback && (
        ...
        <div className="grid gap-4 md:grid-cols-2 xl:grid-cols-4">
          ...
          <div className="rounded-[28px] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6 shadow-sm">
            <div className="flex items-center gap-3">
              ...
              <div>
                <p className="text-sm font-semibold text-slate-900 dark:text-slate-100">Revenue</p>
                <p className="text-2xl font-bold text-slate-900 dark:text-slate-100">
        ...
        <div className="rounded-[28px] border border-slate-200 dark:border-slate-800 bg-white dark:bg-slate-950 p-6 shadow-sm">
          <div className="flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
            <div>
              <h3 className="text-lg font-bold text-slate-900 dark:text-slate-100">All Orders</h3>
